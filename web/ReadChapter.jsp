...
<html>
        <head>
                ...
                <title>${currNovel.novelName} - ${currChapter.chapterName}</title>
        ...
        <body>
                ...
                <div style="text-align: center">
                        ...
                        <h2>Chapter: ${currChapter.chapterName}</h2>
                </div>
                ...
                <div class="navigator">
                        <c:if test="${prevChap != null}">
                                <a class="fw" href="NovelServlet?action=read&nid=${prevChap.novel.novelID}&cid=${prevChap.chapterID}" class="changeChapter">Previous Chapter</a>
                        </c:if>
                        <c:if test="${nextChap != null}">
                                <a class="fw" href="NovelServlet?action=read&nid=${nextChap.novel.novelID}&cid=${nextChap.chapterID}" class="changeChapter">Next Chapter</a>
                        </c:if>
                        <a class="goback" href="NovelServlet?action=NovelInfo&nid=${currNovel.novelID}">Back to chapters list</a>
                </div>
                        ...
                        <c:if test="${sessionScope.user != null}">
                                <div>
                                        <form action="CommentServlet" method="POST" id="form">
                                                <textarea name="context" placeholder="Maximum 200 characters" id="cmtInput"></textarea><span style="visibility:hidden; color:red" id="cmtMsg">Maximum: 200 characters</span> <br>
                                                <input type="hidden" name="chapterID" value="${currChapter.chapterID}"/>
